...
import io.ruv.parcelservice.service.converter.ParcelConverter;
import io.ruv.parcelservice.service.exception.ParcelNotFoundException;
import io.ruv.parcelservice.service.workflow.ParcelWorkflowService;
...
public class ParcelServiceImpl implements ParcelService {
    ...
    @Override
    @Transactional
    public ParcelDto updateParcelStatus(long id, ParcelStatus status, UserInfo userInfo) {
    ...
    private ParcelDto changeParcelStatus(Parcel parcel, ParcelStatus newStatus, UserInfo userInfo, @Nullable String assignee) {
